...
\ea%24
    ...
    \gll notante   iudice   quo     nosti        \\
         judging\textsubscript{ABL}   the judge\textsubscript{ABL}   who\textsubscript{ABL}   (you) know       \\\jambox{\textsc{acc} → \textsc{abl}}
...
\ea%25
    ...
    \gll άνδρες 	άξιοι  	της 	έλευθερίας 	ής 	κέκτησθε\\
             men   worthy   the\textsubscript{GEN}   freedom\textsubscript{GEN}   which\textsubscript{GEN} you.possess  \\\jambox{\textsc{acc} → \textsc{gen}}
...
\ea%26
    ...
    \glt \ConnectTail{Siedmiu} mężczyzn [\textsubscript{CP} \NodeConnectHead[{Triangle[]}-{Triangle[]}][2ex]{\textbf{którzy}}{\footnotesize agree\textsuperscript{??}+\st{\textsc{acc}}}*\ConnectTail{\textsubscript{NOM}}[B] $\langle$\st{siedmiu mężczyzn}$\rangle$ C [\textsubscript{TP} \NodeConnectHead[{Triangle[]}-{Triangle[]}][2ex]{T}[B]{\footnotesize\textsc{nom}} [\textsubscript{vP} \ConnectHead[7ex]{t\textsubscript{którzy}}[B]\textsubscript{$\langle$\st{siedmiu mężczyzn}$\rangle$}...]]]
\z

\todo{in the original, \textsc{acc} was crossed out with a thick red X. Is it OK if we use normal strikeout here?}
...
\ea%27
    ...
    \glt \ConnectTail{Siedem} kobiet [\textsubscript{CP} \textbf{które}\NodeConnectHead[{Triangle[]}-{Triangle[]}][2ex]{\textsubscript{\textbf{\textsc{nom}}}}{\footnotesize agree\textsuperscript{??}+\textsc{acc}}*\textsubscript{\slash}\ConnectTail{\textsubscript{\textbf{\textsc{acc}}}}[C] $\langle$\st{siedem kobiet}$\rangle$ C [\textsubscript{TP} \ConnectHead*[2ex]{T}[C] [\textsubscript{vP} t\textsubscript{\NodeConnectHead[{Triangle[]}-{Triangle[]}][8ex]{które}[C]{\footnotesize\scshape nom}$\langle$\st{siedem kobiet}$\rangle$}...]]]
\z
...
\glt Poznałem \ConnectTail{siedem}[D] kobiet [\textsubscript{CP} \textbf{które}\NodeConnectHead[{Triangle[]}-{Triangle[]}][3ex]{\textsubscript{\footnotesize\textbf{\textsc{nom}}}}[D]{agree\textsuperscript{??}+\textsc{\st{acc}}}*\textsubscript{\slash}\ConnectTail{\textsubscript{\textbf{\textsc{acc}}}}[E] $\langle$\st{siedem kobiet}$\rangle$ C [\textsubscript{TP} \ConnectHead[2ex]{T}[E]* [\textsubscript{vP} t\NodeConnectHead[{Triangle[]}-{Triangle[]}][9ex]{\textsubscript{które}}[E]{\footnotesize\textsc{nom}}\textsubscript{$\langle$\st{siedem kobiet}$\rangle$} ... ]]]
\z
...
\ea%33
    ...
    \glt \ConnectTail{Siedmiu} mężczyzn [\textsubscript{CP} \NodeConnectHead[{Triangle[]}-{Triangle[]}][2ex]{\textbf{Op\textsubscript{NOM}}}{\footnotesize agree\textsuperscript{??}+{\textsc{acc}}}*\ConnectTail{$\langle$\st{siedmiu}}[F]\st{ mężczyzn}$\rangle$ \textbf{co} [\textsubscript{TP} \NodeConnectHead[{Triangle[]}-{Triangle[]}][2ex]{T}[F]{\footnotesize\textsc{nom}} [\textsubscript{vP} \ConnectHead[7ex]{t\textsubscript{Op}}[F]\textsubscript{-$\langle$\st{siedmiu mężczyzn}$\rangle$}...]]]
\z
...
\ea%34
    ...
    \glt Spotkałem \ConnectTail{siedmiu} mężczyzn [\textsubscript{CP} \NodeConnectHead[{Triangle[]}-{Triangle[]}][2ex]{\textbf{Op\textsubscript{NOM}}}{\footnotesize agree\textsuperscript{??}+\st{\textsc{acc}}}*\ConnectTail{$\langle$\st{siedmiu}}[G]\st{ mężczyzn}$\rangle$ \textbf{co} [\textsubscript{TP} \NodeConnectHead[{Triangle[]}-{Triangle[]}][2ex]{T}[G]{\footnotesize\textsc{nom}} [\textsubscript{vP} \ConnectHead[7ex]{t\textsubscript{Op}}[G]\textsubscript{-$\langle$\st{siedmiu mężczyzn}$\rangle$}...]]]
\z
