...
\ea%26
    ...
    \glt \ConnectTail{Siedmiu} mężczyzn [\textsubscript{CP} \NodeConnectHead[{Triangle[]}-{Triangle[]}][2ex]{\textbf{którzy}}{\footnotesize agree\textsuperscript{??}+\st{\textsc{acc}}}*\ConnectTail{\textsubscript{NOM}}[B] <\st{siedmiu mężczyzn}> C [\textsubscript{TP} \NodeConnectHead[{Triangle[]}-{Triangle[]}][2ex]{T}[B]{\footnotesize\textsc{nom}} [\textsubscript{vP} \ConnectHead[7ex]{t\textsubscript{którzy}}[B]\textsubscript{<\st{siedmiu mężczyzn}>}...]]]
\z
...
\ea%27
    ...
    \glt \ConnectTail{Siedem} kobiet [\textsubscript{CP} \textbf{które}\NodeConnectHead[{Triangle[]}-{Triangle[]}][2ex]{\textsubscript{\textbf{\textsc{nom}}}}{\footnotesize agree\textsuperscript{??}+\textsc{acc}}*\textsubscript{\slash}\ConnectTail{\textsubscript{\textbf{\textsc{acc}}}}[C] <\st{siedem kobiet}> C [\textsubscript{TP} \ConnectHead*[2ex]{T}[C] [\textsubscript{vP} t\textsubscript{\NodeConnectHead[{Triangle[]}-{Triangle[]}][8ex]{które}[C]{\footnotesize\scshape nom}<\st{siedem kobiet}>}...]]]
\z
...
\glt Poznałem \ConnectTail{siedem}[D] kobiet [\textsubscript{CP} \textbf{które}\NodeConnectHead[{Triangle[]}-{Triangle[]}][3ex]{\textsubscript{\footnotesize\textbf{\textsc{nom}}}}[D]{agree\textsuperscript{??}+\textsc{\st{acc}}}*\textsubscript{\slash}\ConnectTail{\textsubscript{\textbf{\textsc{acc}}}}[E] <\st{siedem kobiet}> C [\textsubscript{TP} \ConnectHead[2ex]{T}[E]* [\textsubscript{vP} t\NodeConnectHead[{Triangle[]}-{Triangle[]}][9ex]{\textsubscript{które}}[E]{\footnotesize\textsc{nom}}\textsubscript{<\st{siedem kobiet}>} ... ]]]
\z
...
\ea%33
    ...
    \glt \ConnectTail{Siedmiu} mężczyzn [\textsubscript{CP} \NodeConnectHead[{Triangle[]}-{Triangle[]}][2ex]{\textbf{Op\textsubscript{NOM}}}{\footnotesize agree\textsuperscript{??}+{\textsc{acc}}}*\ConnectTail{<\st{siedmiu}}[F]\st{ mężczyzn}> \textbf{co} [\textsubscript{TP} \NodeConnectHead[{Triangle[]}-{Triangle[]}][2ex]{T}[F]{\footnotesize\textsc{nom}} [\textsubscript{vP} \ConnectHead[7ex]{t\textsubscript{Op}}[F]\textsubscript{-<\st{siedmiu mężczyzn}>}...]]]
\z
...
\ea%34
    ...
    \glt Spotkałem \ConnectTail{siedmiu} mężczyzn [\textsubscript{CP} \NodeConnectHead[{Triangle[]}-{Triangle[]}][2ex]{\textbf{Op\textsubscript{NOM}}}{\footnotesize agree\textsuperscript{??}+\st{\textsc{acc}}}*\ConnectTail{<\st{siedmiu}}[G]\st{ mężczyzn}> \textbf{co} [\textsubscript{TP} \NodeConnectHead[{Triangle[]}-{Triangle[]}][2ex]{T}[G]{\footnotesize\textsc{nom}} [\textsubscript{vP} \ConnectHead[7ex]{t\textsubscript{Op}}[G]\textsubscript{-<\st{siedmiu mężczyzn}>}...]]]
\z
