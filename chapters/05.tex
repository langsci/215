...
\ea%26
    ...
    \glt \ConnectTail{Siedmiu} mężczyzn [\textsubscript{CP} \NodeConnectHead[{Triangle[]}-{Triangle[]}][2ex]{\textbf{którzy}}{\footnotesize agree\textsuperscript{??}+\sout{\textsc{acc}}}*\ConnectTail{\textsubscript{NOM}}[B] $\langle$\sout{siedmiu mężczyzn}$\rangle$ C [\textsubscript{TP} \NodeConnectHead[{Triangle[]}-{Triangle[]}][2ex]{T}[B]{\footnotesize\textsc{nom}} [\textsubscript{vP} \ConnectHead[7ex]{t\textsubscript{którzy}}[B]\textsubscript{$\langle$\sout{siedmiu mężczyzn}$\rangle$}...]]]
\z
...
\glt Poznałem \ConnectTail{siedem}[D] kobiet [\textsubscript{CP} \textbf{które}\NodeConnectHead[{Triangle[]}-{Triangle[]}][3ex]{\textsubscript{\footnotesize\textbf{\textsc{nom}}}}[D]{agree\textsuperscript{??}+\textsc{\sout{acc}}}*\textsubscript{\slash}\ConnectTail{\textsubscript{\textbf{\textsc{acc}}}}[E] $\langle$\sout{siedem kobiet}$\rangle$ C [\textsubscript{TP} \ConnectHead[2ex]{T}[E]* [\textsubscript{vP} t\NodeConnectHead[{Triangle[]}-{Triangle[]}][9ex]{\textsubscript{które}}[E]{\footnotesize\textsc{nom}}\textsubscript{$\langle$\sout{siedem kobiet}$\rangle$} ... ]]]
\z
...
\ea%33
    ...
    \glt \ConnectTail{Siedmiu} mężczyzn [\textsubscript{CP} \NodeConnectHead[{Triangle[]}-{Triangle[]}][2ex]{\textbf{Op\textsubscript{NOM}}}{\footnotesize agree\textsuperscript{??}+{\textsc{acc}}}*\ConnectTail{$\langle$\sout{siedmiu}}[F]\sout{ mężczyzn}$\rangle$ \textbf{co} [\textsubscript{TP} \NodeConnectHead[{Triangle[]}-{Triangle[]}][2ex]{T}[F]{\footnotesize\textsc{nom}} [\textsubscript{vP} \ConnectHead[7ex]{t\textsubscript{Op}}[F]\textsubscript{-$\langle$\sout{siedmiu mężczyzn}$\rangle$}...]]]
\z
...
\ea%34
    ...
    \glt Spotkałem \ConnectTail{siedmiu} mężczyzn [\textsubscript{CP} \NodeConnectHead[{Triangle[]}-{Triangle[]}][2ex]{\textbf{Op\textsubscript{NOM}}}{\footnotesize agree\textsuperscript{??}+\sout{\textsc{acc}}}*\ConnectTail{$\langle$\sout{siedmiu}}[G]\sout{ mężczyzn}$\rangle$ \textbf{co} [\textsubscript{TP} \NodeConnectHead[{Triangle[]}-{Triangle[]}][2ex]{T}[G]{\footnotesize\textsc{nom}} [\textsubscript{vP} \ConnectHead[7ex]{t\textsubscript{Op}}[G]\textsubscript{-$\langle$\sout{siedmiu mężczyzn}$\rangle$}...]]]
\z
