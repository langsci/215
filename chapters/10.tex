...
The interpretative and structural diagnostics have shown that the subject-object asymmetry of BP null possessives is not present in EP. The results are summarized in \tabref{tab:key:1} below.
...
In what follows, I sketch this idea. With respect to the placement of the possessive within the DP, there are two types of structures that have been discussed in the literature. The structures are represented in \figref{fig:key:3} as type A (Kupisch \& \citealt{Rinke2011}; \citealt{Alexiadou2005}) and type B (\citealt{Parodi1994}; \citealt{Brito2007}).

  
%%please move the includegraphics inside the {figure} environment
%%\includegraphics[width=\textwidth]{OGSVolumeAug2018Weingart-img3.png}
 

\textit{\figref{fig:key:3}: Position of the possessive pronoun in EP}
