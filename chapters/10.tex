...
\ea%49
         EP\label{ex:wein:49}\\
    \ea  
    \gll a minha cadeira \slash amiga\\
         the my chair \slash friend\\
    \ex  
    \gll uma cadeira \slash amiga minha\\
         a chair \slash friend my\\
    \z
\z
...
\draw[dashed] (flor.south) -- ++(0,-.5\baselineskip) -| (poss.south)  node[midway,below] {establishing a free R(elation) between y and x};
\end{forest}
...
\ea%54
    \label{ex:wein:54}
    \ea[]{
    \gll Gianni ha accarezzato suo padre \slash il padre.\\
         G. has caressed his father \slash the father\\}
    \ex[*]{
