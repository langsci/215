...
Even though \REF{ex:alexiadou:12d} is not perfect, it is much better than (12c). AAIM (2010) take this to be evidence that the subject in BC resides in the embedded clause. 
...
% 
%     it expected{}-\textsc{1sg}    the  John\textsc{{}-}\textbf{\textsc{acc}} \textsc{sbjv} love{}-\textsc{3sg}    the 
% Maria\textsc{{}-acc}
% 
%   
