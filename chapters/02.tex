...
\citet{Tsakali2017} re-evaluate the empirical picture, using extensive questionnaires, by focusing on the following configurations with OC\slash NOC verbs favoring co-reference and NOC verbs that do not favor coreference:
...
Note that, as well as examples like (6) where the embedded subject is nominative, native speakers were also asked to evaluate examples like (14) below involving BC between an embedded dative\slash genitive or accusative experiencer and a matrix null (nominative) subject. 
