...
\ea%24
    \label{ex:giurgea:24}
    [\ConnectTail{T}[A]\textsubscript{[uPerson, uNumber]}  [... \ConnectHead[2ex]{$\alpha$}[A]\textsubscript{+Person{\textsf{\bfseries X}}[pos=0.375,inner sep=0pt]}  [... \NodeConnectHead[-{Triangle[]}][2ex]{IA}[A]\textsubscript{+Person +Number} ...]]]
\z
