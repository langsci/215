...
% 
% \label{bkm:Ref443240869}(23)  a.   A DP must match in all of its (relevant) φ-features with its case licensor (assuming case licensing via Agree; see \citealt{Chomsky2000}; 2001).
% 
...
%     \z
% 
%           a.   S-au             {formulat} \emph{plângeri     de către}{ autoritatea     contractantă}{.}
% 
