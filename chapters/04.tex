...
\textstylest{(10)  a.  Să    nu  uităm        că    la acest moment} \emph{se vorbeşte de către}\textstylest{ autorităţi de    o}\textstylest{} 

\begin{styleDSb}
\textstylest{} \textstylest{\textsc{sbjv} }\textstylest{not forget.1}\textstylest{\textsc{pl}}\textstylest{ that at this   moment} \textstylest{\textsc{se}}\textstylest{ speaks   by          authorities about a} 
\end{styleDSb}

\begin{styleDSb}
\textstylest{       nouă reorganizare administrativ-teritorială.}
\end{styleDSb}

\begin{styleDSb}
\textstylest{       new  reorganization administrative-territorial}
\end{styleDSb}

\begin{styleDSb}
\textstylest{} \textstylest{     ‘Let’s not forget that at this moment the authorities are talking about a new} 
\end{styleDSb}

\begin{styleDSb}
\textstylest{       administrative and territorial reorganization}\textstylest{.’}
\end{styleDSb}

\begin{styleDSb}
\textstylest{                (http://www.verticalonline.ro/autoritatile-comuniste-si-reorganizarea-comunelor-in-1968-i)}
\end{styleDSb}

\begin{styleDSb}
\textstylest{  b}\textstylest{.   Modul        în care    este primit          sau i} \emph{se vorbeşte de  către}\textstylest{ }
\end{styleDSb}

\begin{styleDSb}
\textstylest{        manner-the in which is    received(}\textstylest{\textsc{m)}}\textstylest{ or} \textstylest{\textsc{3sg}}\textstylest{.}\textstylest{\textsc{dat se} }\textstylest{speaks    by employees}
\end{styleDSb}

\begin{styleDSb}
\textstylest{ }\textstylest{anumiţi salariaţi ...}
\end{styleDSb}

\begin{styleDSb}
\textstylest{        certain  employees}
\end{styleDSb}

\begin{styleDSb}
\textstylest{} \textstylest{      ‘The manner in which certain employees receive him or talk to him...}\textstylest{’} 
\end{styleDSb}

\begin{styleDSb}
\textstylest{    (}\textstyleHTMLCite{www.primariatantareni.ro/images/stories/ziar\_ianuarie.pdf}\textstylest{)}
\end{styleDSb}
...
\textstylest{(13)} \textstylest{proiectul   de  acord         la care} \emph{s-a      ajuns    de către}\textstylest{ cele 47 de state membre}\textstylest{} 

project-the of agreement to which \textsc{se-}has arrived by         the  47      states member 

\textstylest{ale   Consiliului          Europei} \textstylest{(}\textstyleHTMLCite{www.europarl.europa.eu/sides/...}\textstylest{)}

\textstylest{\textsc{gen}}\textstylest{ Council-the.}\textstylest{\textsc{gen} }\textstylest{Europe-the.}\textstylest{\textsc{gen}}
...
\textstylest{(14)  a.  Se  sperie     de întuneric} \textstylest{    /  Se grăbeşte}
...
b.   \textstylest{*Se se sperie      / grăbeşte}
...
\ea%29
    ...
    \z
          ...
          a.   S-au             \textstylest{formulat} \emph{plângeri     de către}\textstylest{ autoritatea     contractantă}\textstylest{.}
...
Dobrovie-Sorin, Carmen. 2017. Reflexive-marking in Romance: Voice and feature deficiency. In Everaert, Martin \& van Riemsdijk, Henk (eds.), \textit{The Blackwell companion to syntax},\textstylest{ 2nd revised edn.} Oxford: Blackwell.
