...
\todo[inline]{There is no Obenauer 1984 reference; do you mean Obenauer 1994?}
\ea%1
    \label{ex:mensch:1}
    \ea[*]{
...
\ea%4
    ...
    \gll Le Corbusier [\textsubscript{PP} dont] [\textsubscript{DP}  la  maison [\textsubscript{PP}  dont] [\textsubscript{PP}  de  M.  X]] n’  est  guère  confortable.\\
         Le C.  {}    of.whom {}  the  house {}   of.which {}  of  Mr. X \textsc{neg}  is  hardly  comfortable\\
...
\todo[inline]{I changed the Zeijlstra reference to the journal article from 2012}
...
\ea%13
    ...
    \ex  
    \gll L’ attaque  des  partisans  \textit{a}  \textit{commencé}  \textit{à} \textit{7 heures}. (IDP)\\
         the attack  of.the  partisans  has  begun    at {7 o’clock}\\
    \glt ‘The attack of the partisans began at 7 o’clock.’
    \ex  
    \gll L’  attaque  de(s)   partisans  \textit{ce}  \textit{matin}    n’ était    pas       une  attaque  de  partisans.\\
