...
\ea%9
    ...
    \glt ‘Corot, by whom the portrait \_\_ of this young woman is located in the Barnes Foundation ...’ (examples from \citealt{Godard1992}: 268–269, following \citealt{Ruwet1972}; also cf. Sag \& \citealt{Godard1994}).  }
    \z
\z    
...
\ea%10
    (repeated from (4), from \citealt{Milner1978b}; 1982; quoted in Sag \& \citealt{Godard1994})\label{ex:mensch:10}\\
    \ea[*]{
    \gll Le Corbusier [\textsubscript{PP} dont] [\textsubscript{DP}  la  maison [\textsubscript{PP}  dont] [\textsubscript{PP}  de  M.  X]]     n’  est  guère  confortable] ...\\
             Le C.                 of.which  the  house    of.which  of   Mr. X     \textsc{neg}  is  hardly  comfortable\\
    \glt     ‘Le Corbusier, by whom the house \_\_ of Mr. X. is hardly comfortable ...’  }
...
\ea%17
Spanish (Gutiérrez-\citealt{Bravo2001}: 111)\label{ex:mensch:17}\\
    \ea[]{
