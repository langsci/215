...
\gll muɳɖ- e-  d-  i/-ĩã    kita:b   /   kitabb-a\\
     boy- \textsc{m.sg-} \textsc{gen-}  \textsc{f.sg/-f.pl}  book.\textsc{abs.f.sg} /   book-\textsc{abs.f.pl}\\
