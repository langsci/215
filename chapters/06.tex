...
\ea%10
    ...
    \glt ‘He comes to tell me some stories at night.’ (Di Caro \& \citealt{Giusti2015}) 
    \z
...
\ea%31
         Minervino Murge, Apulia (Manzini \& \citealt{Savoia2005})\label{ex:lorusso:31}\\
    \gll Væ     u    cæmə. \\
         go.\textsc{2sg} him(\textsc{cl})   call.\textsc{2sg}    \\
    \glt ‘You go to call him.’ 
    \z
...
\ea%32
         Montemilone, Basilicata (Manzini \& \citealt{Savoia2005})\label{ex:lorusso:32}\\
    \gll Va/vinə   u    camə         \\
...
\ea%33
    \label{ex:lorusso:33}
    \ea  Mesagne, Apulia (Manzini \& \citealt{Savoia2005})\\
    \gll Vɔʄʄu     lu  veʃu.      \\
...
\ea%34
         Alliste (Manzini \& \citealt{Savoia2005})\label{ex:lorusso:34}\\
    \gll ʃta     llu     tʃɛrku    \\
