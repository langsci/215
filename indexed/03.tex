...
\ea%3
    \label{ex:gallego:3}
     ...
     \ex \ldots\xspace XP cannot be a \isi{Goal} (no \is{quantifier}pseudopassives)
     \end{xlisti}
\z
...
The first option is tempting in the case of the hybrid pattern, where the \isi{preposition} has a clear-cut functional nature – like \is{complementizer}complementizers, as \citet{Kayne2004} argues. This is in fact the approach that \citet{Ordóñez2016} put forward in their analysis of \DOM, whose derivation is reproduced in (35) for a sentence like (34):
