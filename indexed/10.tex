...
The readings under \isi{ellipsis} are shown in (43) for simple possessives and in (44) for complex possessives. Under \isi{ellipsis}, the simple possessive only allows for the \is{sloppy and strict identity}sloppy reading:
