...
% 
% Belletti, Adriana. 1982. Morphological passive and pro-drop: The \isi{impersonal} construction in \ili{Italian}. \textit{Journal of Linguistic Research} 2. 1–34.
% 
...
% 
% Burzio, Luigi. 1986. \textit{\ili{Italian} syntax}: \textit{A government-binding approach}. Dordrecht: Reidel.
% 
...
% 
% Collins, Chris. 2005. A smuggling approach to the passive in \ili{English}. \textit{Syntax} 8. 81–120.
% 
...
% 
% Labelle, Marie. 2008. The \ili{French} \isi{reflexive} and reciprocal \textit{se}. \textit{Natural Language \& Linguistic Theory} 26. 833–876.
% 
...
% 
% Manzini, Rita. 1986. On \ili{Italian} \textit{si}. In Borer, Hagit (ed.), \textit{The syntax of pronominal clitics}, 241–262. New York: Academic Press.
% 
...
% 
% Sigurðsson, Halldór Ármann. 2004. The syntax of Person, Tense, and speech features. \textit{\ili{Italian} Journal of Linguistics} 16. 219–251.
% 
...
% 
% Zribi-Hertz, Anne. 1982. The ‘middle-\textit{se}’ construction in \ili{French} and its status in the triad middle voice–passive–\isi{reflexive}. \textit{Lingvisticae Investigationes} 6. 345–401.
% 
