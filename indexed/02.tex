...
The authors do, however, notice some important differences between \isi{quasi-ECM} verbs and \is{control!object control}object control verbs. First, as they state (\citealt{Kotzoglou2007}: 129), “there is a crucial difference in the thematic information that is realized in the \ili{Greek} examples. Object control verbs cannot select a clause as their single argument, while this was shown to be possible in the \isi{quasi-ECM} examples.” Moreover, \is{control!object control}object control verbs “always realize the subject matter role as a clause. They thus lack the PP alternate that is attested with verbs of the ‘\isi{quasi-ECM}’ type.” A second difference involves \textit{wh}-extraction, which is banned in \ili{Greek} ‘\isi{quasi-ECM}’ domains, but is licit out of the \is{control!object control}object control clause; see \REF{ex:alexiadou:43} (their 42):
...
On the \is{control!backward control}backward control analysis, this asymmetry is puzzling and unexpected. If, however, control does not involve movement, as \citet{Tsakali2017} argue, then the observed asymmetry boils down to configurations that enable co-reference; i.e. the formation of \is{agreement!long-distance agreement}long-distance agreement chains of the type we described in §3. 
