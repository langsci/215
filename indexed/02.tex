...
Constructions that could be analyzed as ECM in \ili{Greek} involve perception and causative verbs (cf. \citealt{Burzio1986} for \ili{Italian}):
...
Under the assumption that \isi{quantifier} scope is clause-bounded, the difference between (\ref{ex:alexiadou:38}a) and (\ref{ex:alexiadou:38}b) follows if (\ref{ex:alexiadou:38}b) has the two \is{quantifier}quantifiers in different clauses. 
